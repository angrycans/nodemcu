...
/* 强制字体和基础样式 */
body {
    font-family: "Microsoft YaHei", "Source Han Sans CN", "PingFang SC", sans-serif !important;
    line-height: 1.6;
    padding: 20px;
}
/* 修正图片溢出 */
...
#### 1. FlyPT Mover 配置
在 FlyPT Mover 的 Serial 输出模块中，使用以下连接字符串：
`flypt:Y7<Axis1a><Axis2a><Axis3a><Axis4a><Axis5a><Axis6a>00!!`

#### 2. SimHub 配置
在 SimHub 的 "ShakeIt For Controllers" -> "Custom Protocol" 中，按下图进行串口与指令配置：

![SimHub 配置](simhub_serial_config.png)

**配置要点：**
- **Baudrate**: 115200
- **DTR / RTS**: 全部开启 (Enable)
- **Bit Range**: 16 bit
- **指令内容**: `Y7<Axis1b><Axis2b><Axis3b><Axis4b><Axis5b><Axis6b><Axis7b>!!`

---

## 4. 伺服器设置

![伺服驱动器参数设置](s2_config.png)
