/*
卡丁车5轴 上层3轴 代码 行程100
开机自动归零点，然后停止 ，real_motors=3 flypt 连接去中点
*/
#include <Arduino.h>
...
const unsigned int RANGE_SAFE = 30000; // 100mm行程=20000
...
// check connection to motors 0..1
    ...
    return;
#endif
    debug_println("motors_check end");
