...
static void ublox_payload_decode(UBLOX_RAW_t raw_data)
{
    if (raw_data.class1 == UBLOX_NAV_CLASS)
    {
        ...
        case UBLOX_NAV_PVT:
            ...
            gps_time.year = raw_data.payload.pvt.year;
            gps_time.month = raw_data.payload.pvt.month;
            gps_time.day = raw_data.payload.pvt.day;
            gps_time.hour = raw_data.payload.pvt.hour;
            gps_time.min = raw_data.payload.pvt.min;
            gps_time.sec = raw_data.payload.pvt.sec;
            break;
